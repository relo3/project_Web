<?php
    ...
    if (
        ...
        if (
            ...
            //aaleh mayrajaach lel affichage
        }
        else
...
<html style="font-size: 16px;">
  <head>
    ...
    <body class="u-body u-xl-mode">
        ...
        <button><a class="u-border-2 u-border-black u-btn u-button-style u-hover-black u-none u-text-hover-white u-btn-1" href="afficherListeticket.php">Retour à la liste des tickets</a></button>
        <hr>
      ...
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-form-group u-label-left u-form-group-1">
              <label for="Numtickets" class="u-label">Ticket</label>
              <input type="number" placeholder="" name="Numtickets" id="Numtickets" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
            </div>
            <div class="u-form-group u-form-name u-label-left u-form-group-2">
              <label for="nom" class="u-label">Nom</label>
              <input type="text" name="nom" id="nom" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required>
            </div>
            <div class="u-form-group u-form-name u-label-left u-form-group-2">
              <label for="prenom" class="u-label">Prenom</label>
              <input type="text" name="prenom" id="prenom" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required>
            </div>
            <div class="u-form-date u-form-group u-label-left u-form-group-3">
              <label for="dateConcert" class="u-label">Date</label>
              <input type="date" placeholder="MM/DD/YYYY" name="dateConcert" id="dateConcert" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required>
            </div>
            <div class="u-form-address u-form-group u-label-left u-form-group-4">
              <label for="email" class="u-label">Email</label>
              <input type="email" name="email" id="email" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required>
            </div>
