<?php
    ...
    if (
        ...
        if (
            ...
            $ticketC->modifierticket($ticket, $_POST["Numtickets"]);
      ...
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-form u-form-1">
            ...
            if(isset($_POST['Numtickets'])){
                $ticket = $ticketC->recupererticket($_POST['Numtickets']);
            }
            ?>
        ...
        <div class="u-form-group u-label-left u-form-group-1">
              ...
              <input type="text" placeholder="" name="Numtickets" id="Numtickets" disabled value="<?php echo $ticket['Numtickets']; ?>">
            </div>
            <div class="u-form-group u-form-name u-label-left u-form-group-2">
              <label for="nom" class="u-label">Nom</label>
              <input type="text" name="nom" id="nom" disabled="disabled" value="<?php echo $ticket['nom']; ?>">
            </div>
            <div class="u-form-group u-form-name u-label-left u-form-group-2">
              <label for="prenom" class="u-label">Prenom</label>
              <input type="text" name="prenom" id="prenom" disabled value="<?php echo $ticket['prenom']; ?>">
            </div>
            <div class="u-form-date u-form-group u-label-left u-form-group-3">
              <label for="dateConcert" class="u-label">Date</label>
              <input type="date" placeholder="MM/DD/YYYY" name="dateConcert" id="dateConcert" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" value="<?php echo $ticket['daetConcert']; ?>" required>
            </div>
            <div class="u-form-address u-form-group u-label-left u-form-group-4">
              <label for="email" class="u-label">Email</label>
              <input type="email" name="email" id="email" value="<?php echo $ticket['email']; ?>" disabled>
            </div>
