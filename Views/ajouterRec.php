...
<html style="font-size: 16px;">
  <head>
    ...
    <body class="u-body u-xl-mode">
        ...
        <button><a class="u-border-2 u-border-black u-btn u-button-style u-hover-black u-none u-text-hover-white u-btn-1" href="afficherRec.php">Retour à la liste des réclamations</a></button>
        <hr>
