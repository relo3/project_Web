...
<link rel="stylesheet" href="./Affiche/Accueil2.css" media="screen">
  ...
  <body class="u-body u-xl-mode"><header class="u-clearfix u-grey-70 u-header u-header" id="sec-ab0a"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <button><a class="u-border-2 u-border-black u-button-style u-hover-black u-none u-text-hover-white u-btn-1" href="afficherListeticket.php">Retour à la liste des tickets</a></button>
        <hr>
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-align-center u-text u-text-default u-text-1">GESTION reclamation</h1>
		...
		<table class="u-table-entity">
            ...
            <thead class="u-black u-table-header u-table-header-1">
              <tr style="height: 21px;">
                <th class="u-border-1 u-border-black u-table-cell">Numconcert</th>
			...
			<?php
				foreach($listeRec as $reclamation){
					if (
						isset($reclamation["Numtickets"]) &&
						isset($reclamation["contenu"])&&
						isset($reclamation["dateConcert"])
					) {
						if (
							!empty($reclamation["Numtickets"]) && 
							!empty($reclamation["contenu"])&&
							!empty($reclamation["dateConcert"])
						) {
			?>
            <tbody class="u-table-body">
              <tr style="height: 75px;">
			  
				<td class="u-border-1 u-border-grey-30 u-table-cell"><?php echo $reclamation['Numtickets']; ?></td>
        <td class="u-border-1 u-border-grey-30 u-table-cell"><?php echo $reclamation['contenu']; ?></td>
				<td class="u-border-1 u-border-grey-30 u-table-cell"><?php echo $reclamation['dateConcert']; ?></td>
				<td class="u-border-1 u-border-grey-30 u-table-cell">
				<form method="POST" action="supprimerRec.php">
						<input  type="submit" name="Modifier" value="Supprimer">
						<input type="hidden" value=<?PHP echo $reclamation['Numtickets']; ?> name="Numtickets">
					</form>
				</td>
              </tr>
            </tbody>
