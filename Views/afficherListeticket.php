...
<link rel="stylesheet" href="./Affiche/Accueil2.css" media="screen">
  ...
  <body class="u-body u-xl-mode"><header class="u-clearfix u-grey-70 u-header u-header" id="sec-ab0a"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <button><a class="u-border-2 u-border-black u-button-style u-hover-black u-none u-text-hover-white u-btn-1" href="afficherRec.php">Liste des réclamations</a></button>
        <hr>
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-align-center u-text u-text-default u-text-1">GESTION tickets</h1>
        <a href="ajouterticket.php" class="u-border-2 u-border-black u-btn u-button-style u-hover-black u-none u-text-hover-white u-btn-1">AJOUTER</a>
		...
		<table class="u-table-entity">
            ...
            <tbody class="u-table-body">
              <tr style="height: 75px;">
				...
				<td class="u-border-1 u-border-grey-30 u-table-cell"><?php echo $ticket['Numtickets']; ?></td>
				...
				<td class="u-border-1 u-border-grey-30 u-table-cell">
					<form method="POST" action="modifierticket.php">
						...
						<input type="hidden" value=<?PHP echo $ticket['Numtickets']; ?> name="Numtickets">
					</form>
				</td>
				<td class="u-border-1 u-border-grey-30 u-table-cell">
