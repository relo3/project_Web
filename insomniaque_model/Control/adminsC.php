...
class adminsC {
    ...
    function classementadmins1(){
        $sql="SELECT id_a,nom_a,prenom_a,mail_a FROM admin_c order by id_a asc";
        $db = config2::getConnexion();
        try{
            $listeadmins = $db->query($sql);
            return $listeadmins;
        }
        catch(Exception $e){
            die('Erreur:'. $e->getMeesage());
    ...
    function classementadmins2(){
        $sql="SELECT id_a,nom_a,prenom_a,mail_a FROM admin_c order by nom_a asc";
        $db = config2::getConnexion();
        try{
            $listeadmins = $db->query($sql);
            return $listeadmins;
