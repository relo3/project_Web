  ...
  <a class="u-border-2 u-border-black u-btn u-btn-submit u-button-style u-custom-color-1 u-hover-black u-text-black u-text-hover-white u-btn-1" href="afficherListePacks.php">Pack</a>
    ...
    <section class="u-clearfix u-section-1" id="sec-38e4">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-align-center u-text u-text-default u-text-1">tables Packs</h1>
        <a href="ajouterpack.php" class="u-border-2 u-border-black u-btn u-btn-submit u-button-style u-custom-color-1 u-hover-black u-text-black u-text-hover-white u-btn-1">ajouter</a>
        <div >
          ...
          <table class="u-table-entity">
            ...
            <thead class="u-black u-table-header u-table-header-1">
              <tr style="height: 21px;">
                ...
                <th class="u-border-1 u-border-black u-table-cell">Offre</th>
...
<tbody  class="u-table-body">
			...
			<tr style="height: 75px;">
				<td class="u-border-1 u-border-grey-30 u-table-cell"><?php echo $pack['nom']; ?></td>
				<td class="u-border-1 u-border-grey-30 u-table-cell"><?php echo $pack['offre']; ?></td>
        ...
        <form method="POST" action="modifierpack.php">
						...
						<input type="hidden" value=<?PHP echo $pack['id_pack']; ?> name="id_pack">
					</form>
				</td>
				<td class="u-border-1 u-border-grey-30 u-table-cell">
					<a href="supprimerpack.php?id_pack=<?php echo $pack['id_pack']; ?>" class="u-border-2 u-border-black u-btn u-btn-submit u-button-style u-custom-color-1 u-hover-black u-text-black u-text-hover-white u-btn-1">SUPPRIMER</a>
				</td>
        <td class="u-border-1 u-border-grey-30 u-table-cell">
					<a href="sherach_pack.php?id_pack=<?php echo $pack['id_pack']; ?>" class="u-border-2 u-border-black u-btn u-btn-submit u-button-style u-custom-color-1 u-hover-black u-text-black u-text-hover-white u-btn-1">abonnement</a>
				</td>
