...
<tbody  class="u-table-body">
        ...
        <td class="u-border-1 u-border-grey-30 u-table-cell"><?php echo $abonnement->pack; ?></td>
        ...
        <form method="POST" action="modifierabonnement.php">
				...
				<td class="u-border-1 u-border-grey-30 u-table-cell">
					<a href="supprimerabonnement.php?id=<?php echo $abonnement->id; ?>" class="u-border-2 u-border-black u-btn u-btn-submit u-button-style u-custom-color-1 u-hover-black u-text-black u-text-hover-white u-btn-1">SUPPRIMER</a>
				</td>
