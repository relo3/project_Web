<?php
    ...
    if (
        ...
        if (
            ...
            $packC->modifierpack($pack, $_POST["id_pack"]);
  ...
  <body class="u-body u-xl-mode"><header class="u-clearfix u-grey-70 u-header u-header" id="sec-0a60"><div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-section-1" id="sec-62ee">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-text u-text-default u-text-1">Modifier Packs<br>
        </h1>
       ...
       <?php
			if (isset($_POST['id_pack'])){
				$pack = $packC->recupererpack($_POST['id_pack']);
          ...
          <div class="u-form-group u-label-left u-form-group-1">
              ...
              <input  id="id_pack" name="id_pack" value="<?php echo $pack['id_pack']; ?>" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" readonly="readonly"  >
            </div>
        
            <div class="u-form-group u-label-left u-form-group-2">
              <label for="date debut" class="u-label">nom</label>
              <input type="text" placeholder="nom" id="nom" name="nom" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white"  value="<?php echo $pack['nom']; ?>"  >
            </div>
            <div class="u-form-group u-form-name u-label-left u-form-group-3">
              <label for="artiste" class="u-label">Offre</label>
              <input type="number" placeholder="%" id="offre" name="offre" value="<?php echo $pack['offre']; ?>" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" >
                  </div>
