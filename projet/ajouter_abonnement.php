  ...
  <body class="u-body u-xl-mode"><header class="u-clearfix u-grey-70 u-header u-header" id="sec-0a60"><div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-section-1" id="sec-62ee">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-text u-text-default u-text-1">AJOUT Abonnement<br>
        </h1>
        ...
        <?php echo $error; ?>
          ...
          <form action="" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" style="padding: 10px;">
            ...
            <div class="u-form-group u-label-left u-form-group-1">
              ...
              <input type="date" placeholder="MM/DD/YYYY" id="date_dabut" name="date_debut" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white"    >
            </div>
            <div class="u-form-group u-form-name u-label-left u-form-group-2">
              <label for="artiste" class="u-label">date fin</label>
              <input type="date" placeholder="MM/DD/YYYY" id="date_fin" name="date_fin" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" >
                  </div>
            <div class="u-form-date u-form-group u-label-left u-form-group-3">
              <label for="date_c" class="u-label">prix</label>
              <input type="number"  id="prix" name="prix" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white"  >
            </div>
