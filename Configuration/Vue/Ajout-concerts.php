      ...
      isset($_POST["id_admin"])
        ...
        if (
          !empty($_POST["id"]) &&
            ...
            $concertsC->ajouterconcerts($concerts);
  ...
  <body class="u-body u-xl-mode"><header class="u-clearfix u-grey-70 u-header u-header" id="sec-0a60"><div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-section-1" id="sec-62ee">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-text u-text-default u-text-1">AJOUT CONCERTS<br>
        </h1>
        ...
        <?php echo $error; ?>
          ...
          <label for="id" class="u-label">ID</label>
              <input type="number" id="id" name="id" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white"    >
                 </div>
            <div class="u-form-group u-label-left u-form-group-1">
              <label for="concert" class="u-label">Concert</label>
              <input type="text" id="concert" name="concert" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white"    >
            </div>
            <div class="u-form-group u-form-name u-label-left u-form-group-2">
              <label for="artiste" class="u-label">Artiste</label>
              <input type="text" id="artiste" name="artiste" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" >
                  </div>
            <div class="u-form-date u-form-group u-label-left u-form-group-3">
              <label for="date_c" class="u-label">Date</label>
              <input type="date" placeholder="MM/DD/YYYY" id="date_c" name="date_c" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white"  >
            </div>
            <div class="u-form-address u-form-group u-label-left u-form-group-4">
              <label for="adresse" class="u-label">Adresse</label>
              <input type="text" id="adresse" name="adresse" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" >
              
            </div>
            <div class="u-form-address u-form-group u-label-left u-form-group-4">
              <label for="prix" class="u-label">Prix</label>
              <input type="text" id="prix" name="prix" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" >
              
            </div>
            <div class="u-form-address u-form-group u-label-left u-form-group-4">
              <label for="id_admin" class="u-label">ID Admin</label>
              <input type="text" id="id_admin" name="id_admin" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" >
